...
function init_gear_sets()
    ...
    sets.midcast.Enmity = {ammo="Iron Gobbet",
        head="Hero's Galea",neck="Knight's Beads",ear2="Cryptic Earring",
        body="Souveran Cuirass +1",hands="Valor Gauntlets",ring1="Vengeful Ring",ring2="Apeile Ring",
        back="Fierabras's Mantle",waist="Goading Belt",legs="Valor Breeches"}

    sets.midcast.Flash = set_combine(sets.midcast.Enmity, 
        -- {legs="Enif Cosciales",feet="Cizin Greaves"} 
        {}
        )
    ...
    head={ name="Jumalik Helm", augments={'MND+1','Magic burst dmg.+4%',}},
    body={ name="Souv. Cuirass +1", augments={'HP+105','Enmity+9','Potency of "Cure" effect received +15%',}},
    hands={ name="Founder's Gauntlets", augments={'STR+9','"Mag.Atk.Bns."+7',}},
