...
function user_setup()
 ...
 state.JugMode = M{['description']='Jug Mode', 'BlackbeardRandy', 'FleetReinhard', 'AttentiveIbuki', 'SwoopingZhivago', 'ScissorlegXerin', 'AlluringHoney', 'WarlikePatrick',
        'HeadbreakerKen', 'AmiableRoche', 'BouncingBertha', 'ThreestarLynn', 'HeraldHenry'}
	...
	send_command('bind !f11 gs equip sets.RegenAxes')
...
function init_gear_sets()
    ...
    Pet_PDT_back = "Artio's Mantle"
	
    Ready_Atk_head = { name="Acro Helm", augments={'Pet: Attack+21 Pet: Rng.Atk.+21','Pet: "Dbl. Atk."+5',}}
    Ready_Atk_body = { name="Acro Surcoat", augments={'Pet: Attack+22 Pet: Rng.Atk.+22','Pet: "Dbl. Atk."+5',}}
    Ready_Atk_hands = "Acro Gauntlets"
    Ready_Atk_legs = { name="Valor. Hose", augments={'Pet: Attack+27 Pet: Rng.Atk.+27','Pet: "Subtle Blow"+10','Pet: STR+4','Pet: Accuracy+15 Pet: Rng. Acc.+15',}}
    Ready_Atk_feet = { name="Valorous Greaves", augments={'Pet: Attack+24 Pet: Rng.Atk.+24','Pet: "Subtle Blow"+5','Pet: Accuracy+8 Pet: Rng. Acc.+8',}}
    Ready_Atk_back = "Artio's Mantle"

    Ready_Acc_head =  {name="Valorous Mask", augments={'Pet: Accuracy+27 Pet: Rng. Acc.+27','Pet: "Store TP"+8','Pet: MND+8','Pet: Attack+12 Pet: Rng.Atk.+12',}}
    Ready_Acc_body = {name="Valorous Mail", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: STR+7','Pet: Accuracy+15 Pet: Rng. Acc.+15',}}
    Ready_Acc_hands = { name="Valorous Mitts", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: "Dbl. Atk."+2','Pet: VIT+5','Pet: Attack+8 Pet: Rng.Atk.+8',}}
    Ready_Acc_legs = { name="Valor. Hose", augments={'Pet: Attack+27 Pet: Rng.Atk.+27','Pet: "Subtle Blow"+10','Pet: STR+4','Pet: Accuracy+15 Pet: Rng. Acc.+15',}}
    Ready_Acc_feet = { name="Acro Leggings", augments={'Pet: Accuracy+23 Pet: Rng. Acc.+23','Pet: "Dbl. Atk."+5','STR+9',}}
    Ready_Acc_back = Ready_Atk_back

    Ready_MAB_head = "Taeon Chapeau"
    Ready_MAB_body = "Acro Surcoat"
    Ready_MAB_hands = "Regimen Mittens"
    Ready_MAB_legs = "Acro Breeches"
    Ready_MAB_feet = "Taeon Boots"

    Ready_MAcc_head = "Taeon Chapeau"
    Ready_MAcc_body = "Acro Surcoat"
    Ready_MAcc_hands = "Regimen Mittens"
    Ready_MAcc_legs = "Acro Breeches"
    Ready_MAcc_feet = "Taeon Boots"

    Arktoi = "Arktoi"
    Ready_Atk_Axe = "Nibiru Tabar"
    Ready_Acc_Axe = "Hunaphu"
    Ready_MAB_Axe = "Nibiru tabar"
    Ready_MAcc_Axe = Ready_MAB_Axe
    Ready_Hybrid_Axe = "Skullrender"
    ...
    Hybrid_head = "Taeon Chapeau"
    Hybrid_body = Pet_PDT_body
    Hybrid_hands = Pet_PDT_hands
    Hybrid_legs = "Valorous Hose"
    Hybrid_feet = "Taeon Boots"
    ...
    sets.precast.JA.Reward = {
        head="Bison Warbonnet",ear1="Lifestorm Earring",
        body="Totemic Jackcoat +1",hands="Regimen Mittens",ring1="Solemn Ring",ring2="Sirona's Ring",
        back=Pet_PDT_back, waist="Engraved Belt",legs="Ankusa Trousers",feet="Ankusa Gaiters +1"}
    ...
    --    back="Aisance Mantle +1",waist="Aristo Belt",legs="ankusa trousers",feet="Ankusa Gaiters +1"}
    ...
    --    back=Pet_PDT_back,
    --    waist="Chuq'aba Belt",legs="Ankusa Trousers",feet="Ankusa Gaiters +1"}
    ...
    sets.precast.WS = {ammo="Ginsen",
        ...
        ring1="Candent Ring",ring2="Epona's Ring",
    ...
    --sets.precast.WS['Primal Rend'].WShighAcc = set_combine(sets.precast.WS['Primal Rend'].WSMedAcc, {})
    ...
    sets.midcast.Pet.WS = {
        ...
        ammo="Demonry Core",
        ear1="Hija Earring",ear2="Domesticator's Earring",
		head=Ready_Atk_head,
        body=Ready_Atk_body,
    ...
    sets.midcast.Pet.MagicAccReadyNE = set_combine(sets.midcast.Pet.MagicAccReady, {main="Nibiru Tabar"})

    sets.DTAxeShield = {main=Pet_PDT_AxeMain,
        sub="Pallas's Shield"}

    -- Dual-wield PetOnly Sets
    sets.midcast.Pet.ReadyRecastDWNE = {main="Nibiru Tabar",sub="Charmer's Merlin",legs="Desultor Tassets"}

    sets.midcast.Pet.ReadyDWNE = set_combine(sets.midcast.Pet.ReadyNE, {sub=Ready_Atk_Axe})
    sets.midcast.Pet.ReadyDWNE.MedAcc = set_combine(sets.midcast.Pet.ReadyNE.MedAcc, {sub=Ready_Hybrid_Axe})
    sets.midcast.Pet.ReadyDWNE.HighAcc = set_combine(sets.midcast.Pet.ReadyNE.HighAcc, {main=Arktoi, sub="Hunahpu"})

    sets.midcast.Pet.MagicAtkReadyDWNE = set_combine(sets.midcast.Pet.MagicAtkReadyNE, {main="Nibiru Tabar", sub="Mdomo Axe"})
    sets.midcast.Pet.MagicAtkReadyDWNE.MedAcc = set_combine(sets.midcast.Pet.MagicAtkReadyNE.MedAcc, {main="Nibiru Tabar", sub="Mdomo Axe"})
    sets.midcast.Pet.MagicAtkReadyDWNE.HighAcc = set_combine(sets.midcast.Pet.MagicAtkReadyNE.HighAcc, {main="Nibiru Tabar", sub="Mdomo Axe"})
    ...
    sets.RegenAxes = {main="Buramgh +1",sub="Buramgh"}

    sets.idle = {ammo="Demonry Core",
        head="Twilight Helm",neck="Bathy Choker",ear1="Infused Earring",ear2="Dawn Earring",
    ...
    sets.idle.Pet.Engaged = {ammo="Demonry Core",
        ...
        ring1="Varar Ring",ring2="Defending Ring",
        back=Pet_PDT_back,
        waist="Hurch'lan Sash",
        legs=Pet_Melee_legs,
        feet=Pet_Melee_feet}
    ...
    sets.engaged = {
        ...
        legs=Hybrid_legs,
        feet=Hybrid_feet}
    sets.engaged.LowAccHaste = set_combine(sets.engaged, {})
    sets.engaged.MedAcc = {
        head=Hybrid_head,
        ear1="Steelflash Earring",ear2="Bladeborn Earring",
        body="Mes'yohi Haubergeon",
        ...
        legs=Hybrid_legs,
        feet=Hybrid_feet}
    sets.engaged.MedAccHaste = set_combine(sets.engaged.MedAcc, {})
    sets.engaged.HighAcc = {ammo="Hasty Pinion +1",
        ...
        legs=Hybrid_legs,
        feet=Hybrid_feet}
    sets.engaged.HighAccHaste = set_combine(sets.engaged.HighAcc, {})
    ...
    sets.engaged.LowAccHaste.Hybrid = set_combine(sets.engaged.Hybrid, {})
    ...
    sets.engaged.MedAccHaste.Hybrid = set_combine(sets.engaged.MedAcc.Hybrid, {})
    sets.engaged.HighAcc.Hybrid = set_combine(sets.engaged.HighAcc, {head="Iuitl Headgear +1",
        legs="Iuitl Tights +1",feet="Diamantaire Sollerets"})
    sets.engaged.HighAccHaste.Hybrid = set_combine(sets.engaged.HighAcc.Hybrid, {})

    -- MELEE (DUAL-WIELD) SETS FOR DNC AND NIN SUBJOB
    sets.engaged.DW = {ammo="Ginsen",
        head=DW_head, neck="Asperity Necklace",ear1="Heartseeker Earring",ear2="Dudgeon Earring",
    ...
    sets.engaged.DW.Hybrid = set_combine(sets.engaged.DW, {head="Iuitl Headgear +1",
        back="Mollusca Mantle",hands="Umuthi Gloves",legs="Iuitl Tights +1",feet="Diamantaire Sollerets"})
    sets.engaged.DW.LowAccHaste.Hybrid = set_combine(sets.engaged.DW.Hybrid, {})
    sets.engaged.DW.MedAcc.Hybrid = set_combine(sets.engaged.DW.MedAcc, {head="Iuitl Headgear +1",
        legs="Iuitl Tights +1",feet="Diamantaire Sollerets"})
    sets.engaged.DW.MedAccHaste.Hybrid = set_combine(sets.engaged.DW.MedAcc.Hybrid, {})
    sets.engaged.DW.HighAcc.Hybrid = set_combine(sets.engaged.DW.HighAcc, {head="Iuitl Headgear +1",
        legs="Iuitl Tights +1",feet="Diamantaire Sollerets"})
    sets.engaged.DW.HighAccHaste.Hybrid = set_combine(sets.engaged.DW.HighAcc.Hybrid, {})
    ...
    sets.engaged.PetTank = set_combine(sets.engaged, {
        ...
        legs=Hybrid_legs,
        feet=Hybrid_feet})
    sets.engaged.PetTank.LowAccHaste = set_combine(sets.engaged.PetTank, {})
    sets.engaged.PetTank.MedAcc = set_combine(sets.engaged.PetTank, {})
    sets.engaged.PetTank.MedAccHaste = set_combine(sets.engaged.PetTank, {})
    sets.engaged.PetTank.HighAcc = set_combine(sets.engaged.PetTank, {})
    sets.engaged.PetTank.HighAccHaste = set_combine(sets.engaged.PetTank, {})
    ...
    sets.engaged.DW.PetTank = set_combine(sets.engaged.DW, {
        ...
        legs=Hybrid_legs,
        feet=Hybrid_feet})
    sets.engaged.DW.PetTank.LowAccHaste = set_combine(sets.engaged.DW.PetTank, {})
    sets.engaged.DW.PetTank.MedAcc = set_combine(sets.engaged.DW.MedAcc, {
        ...
        legs=Hybrid_legs,
        feet=Hybrid_feet})
    sets.engaged.DW.PetTank.MedAccHaste = set_combine(sets.engaged.DW.PetTank.MedAcc, {})
    sets.engaged.DW.PetTank.HighAcc = set_combine(sets.engaged.DW.HighAcc, {
        ...
        legs=Hybrid_legs,
        feet=Hybrid_feet})
    sets.engaged.DW.PetTank.HighAccHaste = set_combine(sets.engaged.DW.PetTank.HighAcc, {})
	...
	sets.random_Stuff = { main="Shiromochi", sub="Kusamochi +1",
		body="Trizek Ring", ear1="Reraise Earring", legs="Facility Ring",
...
function job_precast(spell, action, spellMap, eventArgs)
    if player.equipment.main == 'Nibiru Tabar' then
...
function job_handle_equipping_gear(playerStatus, eventArgs)    	
    ...
    if player.equipment.ring1 == 'Warp Ring' or player.equipment.ring1 == 'Vocation Ring' or player.equipment.ring1 == 'Echad Ring' or player.equipment.ring1 == 'Capacity Ring' or player.equipment.ring1 == 'Facility Ring' then
        disable('ring1')
    else
        enable('ring1')
    end
	if player.equipment.ring2 == 'Warp Ring' or player.equipment.ring2 == 'Vocation Ring' or player.equipment.ring2 == 'Echad Ring' or player.equipment.ring2 == 'Capacity Ring' or player.equipment.ring2 == 'Facility Ring' then
        disable('ring2')
    else
        enable('ring2')
    end
