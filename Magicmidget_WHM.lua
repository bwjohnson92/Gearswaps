...
function get_sets()
    ...
    sets.precast.FastCast = {ammo="Incantor Stone",
        ...
        body="Inyanga Jubbah +2",hands="Repartie Gloves",ring1="Kishar Ring",ring2="Rahab Ring",
        back=AlaunusFC, waist="Witful Belt",legs="Ayanmo Cosciales",feet="Regal Pumps +1"}
    ...
    sets.Cure.Standard = {main="Daybreak",sub="Genmei Shield", ammo="Hydrocera",
            head="Vanya Hood",neck="Cleric's Torque",ear1="Roundel Earring",ear2="Nourishing Earring",--10% 3%--
            body="Annointed Kalasiris",hands="Telchine Gloves",ring1="Lebeche ring",ring2="Sirona's Ring", --13%--
            back="Alaunus's Cape",waist="Cascade Belt",legs="Gyve Trousers",feet="Medium's Sabots"}
