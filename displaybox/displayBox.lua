...
function text_setup()
	if (disable_file == true or setting_up == true) then 
		return
	end
	job = "default"
...
function update_message()
	if (disable_file == true or setting_up == true) then return end
	msg = ""
...
function prerender_func()
	if (disable_file == true) then return end
	local curr = os.clock()
